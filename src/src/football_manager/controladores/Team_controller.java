...
public class Team_controller {
    public static void registerTeam(HashMap<String, Person> hashMapPeople, ArrayList<Team> teams, Scanner sc) {
        ...
        String teamName = Team.capitalizeFirstLetterNames(sc.nextLine());
        ...
        while (coach == null) {
            ...
            coach = Team.getCoachByName(hashMapPeople, coachName);
            if (coach == null) {
        ...
        while (owner == null) {
            ...
            owner = Team.getOwnerByName(hashMapPeople, ownerName);
            if (owner == null) {
        ...
        while (true) {
            ...
            Person player = Team.getPlayerByName(hashMapPeople, playerName);
            if (player != null) {
        ...
        Team newTeam = Team.createTeam(teamName, birthDate, city, coach, owner, teamPlayers);
        teams.add(newTeam);
    ...
    public static void deregisterTeam(ArrayList<Team> teams, Scanner scanner) {
        ...
        if (teamToRemove != null) {
            boolean removed = Team.removeTeam(teams, teamToRemove);
            if (removed) {
